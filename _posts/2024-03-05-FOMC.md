...
This project aims to **capture the dynamic relationship between inflation rate and umemployment rate in the U.S.**. Using the deep learning model developed in this project, computers can accurately identify carotid artery areas in ultrasound images of patients, with an accuracy exceeding 95%.
...
- **Input:** FOMC minutes documents from 2006 to 2023 provided by the federal reserve system, as shown in Figure 1.
   ...
   ![](/images/FOMC minutes.png "Figure 1")
