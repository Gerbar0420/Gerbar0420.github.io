...
**1. Fetch text files from the official website**

   - 
   - 

**2. Remove textual information from the text files that is not helpful for text mining**
...
**4. Convert the data into natural language processing format**
